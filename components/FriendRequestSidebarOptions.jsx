...
const FriendRequestSidebarOptions = ({initialUnseenRequestCount, sessionId}) => {
  ...
  return (
    ...
    >
        ...
        <p className='truncate dark:text-white'>Friend requests</p>

        {unseenRequestCount > 0 ? (
          <div className='rounded-full w-5 h-5 text-xm flex justify-center items-center text-white bg-indigo-600'>{unseenRequestCount}</div>
        ) : null}
